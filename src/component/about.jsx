...
function About() {
  ...
  return (
   ...
   <div id='about' className='px-8 md:py-6 md:pt-10 pb-14 md:pb-24 mx-auto'>
 <div className='flex justify-center items-center   gap-4  flex-col md:flex-row   md:gap-28'>
  <div className="relative-wrapper">
    <div className="portrait-about">
      <img src="about.png" alt="portrait" className='w-64 md:w-80' />
    </div>
    <div className="semi-circle-about hidden lg:block">
...
<h4 className='font-bold text-xl text-gray-900'>20+</h4>
    ...
    <a href="dnkem114@gmail.com" className='py-3 px-6 hire' target="_blank" rel="noopener noreferrer">Hire Me</a>
